...
export default {
	...
	props: {
		isMobileView:{type:Boolean, default(){return false}},
		loading: Boolean,
		aggregationData: {type:Array, default(){return []}},
		value: {type:Array, default(){return []}},
		/* eslint-disable no-console */
		setValue : {type:Function, default(){return ()=>{console.log('Please provide a function')}}},
